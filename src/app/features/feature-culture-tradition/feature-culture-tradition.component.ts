  ...
  protected readonly services = [
    {
      ...
      descritpion: "Comme de nombreux groupes au Cameroun, les Ɓàsà’a ont été affectés par la colonisation européenne, ce qui a entraîné des changements sociaux et économiques importants. Depuis l’indépendance du Cameroun en 1960, les Ɓàsà’a, comme les autres groupes ethniques, ont continué à jouer un rôle important dans le développement politique et économique du pays.",
      subtag: "D'Egypte à Ngog Lituba",
      subtitle: "Je me réconcilie avec mes origines",
      subDescription: "De tout leur ensemble, les Ɓàsà’a tirent leur origine de l'Egypte antique. Ils sont des descendants d'un ancêtre commun ; on les retrouve regroupés au sein de trois grandes familles. L'histoire raconte que c'est suite à une querelle familiale que le nom Ɓàsà’a, qui veut dire <<les ravisseurs>>.",
      links: [
        {
          label: "Origine", link: ""
        },
    ...
    },
    {
      ...
      descritpion: "La société Ɓàsà’a est organisée autour des familles élargies et des clans. Les structures de parenté et les rôles de genre sont importants dans l’organisation sociale. Il existe des chefferies traditionnelles avec des chefs qui jouent un rôle dans la gestion des affaires communautaires et le maintien des traditions.",
      subtag: "Héritage culturel Ɓàsà’a",
    ...
    },
    {
      ...
      descritpion: "Les Ɓàsà’a utilisaient le chant, la chanson et les complaintes pour raconter leurs exploits. La danse était toujours associée au chant ; aussi il y avait plusieurs instruments musicaux permettant d'épouser les danses y afférentes.",
      subtag: "J'approfondi mes connaissances",
      subtitle: "Proposer des ateliers",
      subDescription: "En cours de rédaction ...",
      links: [
        {
          label: "La musique", link: ""
        },
        {
          label: "Les danses", link: ""
        },
        {
          label: "La gastronomie", link: ""
        },
        {
          label: "La mode", link: ""
        },
        {
          label: "La chasse et pêche", link: ""
        },
        {
          label: "Etc…", link: ""
        }
